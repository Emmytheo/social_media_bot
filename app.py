...
st.set_page_config(layout="wide", page_icon="🐤", page_title="Twitter Tweet Analyzer and Generator")
import os
import openai
...
with b:
    st.title("Twitter Sentiment Analyzer and AI Marketing Assistant")
